...
<script setup>
import { BxTimer, AnOutlinedUserAdd, PhMagnifyingGlass } from "@kalimahapps/vue-icons";
...
const Esc = async () => {
  try {
    const response = await axios.get(`${import.meta.env.VITE_APP_URL_API}/deleteSession`);
