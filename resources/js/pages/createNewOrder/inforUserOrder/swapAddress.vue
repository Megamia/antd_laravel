    ...
    <div class="content">
      <div class="userInfor">
        <a-radio-group v-model:value="a">
          ...
          <div v-if="address">
            <div class="userItems" v-for="items in address" :key="items.id">
                  ...
                  <div class="userInforRadio">
                    ...
                    <div class="address">
                      <span class="addressUser">
                        {{ items.address }}, {{ items.ward }}, {{ items.district }},
                        {{ items.city }}
                      </span>
                    </div>
                  </div>
              ...
              <div class="iconTrashDiv">
                <BxTrashAlt class="iconTrash" @click="showModal(items.id)" />
...
<script setup>
import { AnOutlinedArrowLeft, CaAddAlt, BxTrashAlt } from "@kalimahapps/vue-icons";
