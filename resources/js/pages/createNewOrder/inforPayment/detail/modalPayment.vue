                ...
                <div class="modal-container">
                    ...
                    <div class="content">
                        <a-radio-group v-model:value="selection" class="radio">
                            <a-radio :value="1">Tiền mặt</a-radio>
                            <a-radio :value="2">Chuyển khoản</a-radio>
                            <a-radio :value="3">Hình thức khác</a-radio>
                        </a-radio-group>
                    </div>
                    <div class="buttonDiv">
...
const emit = defineEmits(["closeModalPayment", "valueInModalPayment"]);
const selection = ref(1);
const selectionText = ref("");
const Cancel = () => {
    emit("closeModalPayment");
};

const apply = async () => {
    try {
        if (selection.value === 1) {
            selectionText.value = "Tiền mặt";
        } else if (selection.value === 2) {
            selectionText.value = "Chuyển khoản";
